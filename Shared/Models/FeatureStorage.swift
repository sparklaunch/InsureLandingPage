...
class FeatureStorage: ObservableObject {
    @Published var features: [Feature] = [
        .init(image: .init("Snappy Process"), title: "Snappy Process", detail: "Our application process can be completed in minutes, not hours. Don't get stuck filing in tedious forms."),
